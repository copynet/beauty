...
<!--START footer-->
<div style="display: none; background-color:<?php echo $nd_options_customizer_footer_4_bg; ?>; <?php echo $nd_options_customizer_footer_4_bg_image; ?>" id="nd_options_footer_4" class="nd_options_section">
